...
<head>
	...
	<title>Book Management | Admin | BookHub</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Here you can Find all available Books Details and also Add, Delete and Modify Book Details</p>
                            </div>
                                    ...
                                    <tr>
                                    	...
                                    	<th>LANGUAGE</th>
											...
											<?php
													...
													$r=mysqli_query($conn,"SELECT * FROM `book_info` WHERE `m_id`='$mid' and `type`='Rent'");
